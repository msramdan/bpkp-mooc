    ...
    <div class="container">
        <div class="section-title text-center">
            <h5 class="section-title__tagline">
                {{ __('Pelatihan Yang Sedang Berlangsung') }}
            ...
            <h2 class="section-title__title">{{ __('Pelatihan Unggulan') }}</h2>
        </div>
        <div class="row align-items-stretch">
            ...
            @empty
                <div class="col-12 text-center py-5">
                    <p class="text-muted mb-0">{{ __('Belum ada pelatihan yang dipublikasikan.') }}</p>
                </div>
            @endforelse
        </div>
    </div>
