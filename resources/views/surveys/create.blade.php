...
@section('title', __('Tambah Bank Soal / Kuesioner'))

@section('content')
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1 class="page-title fw-medium fs-18 mb-2">{{ __('Tambah Bank Soal / Kuesioner') }}</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('surveys.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary btn-wave">
                            <i class="ri-save-line me-1"></i>{{ __('Simpan Soal / Kuesioner') }}
                        </button>
                    </form>
                </div>
            </div>
