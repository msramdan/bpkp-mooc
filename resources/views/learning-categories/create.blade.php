...
@section('title', __('Create Learning Category'))

@section('content')
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            <h1 class="page-title fw-medium fs-18 mb-2">{{ __('Create Learning Category') }}</h1>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title mb-0">{{ __('Create a new learning category.') }}</div>
                </div>
                <div class="card-body">
                    <x-alert />

                    <form action="{{ route('learning-categories.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
